      ...
      <div>
        ...
        <div>
          ...
          <Nav bsStyle="tabs" activeKey="1" onSelect={this.handleSelect}>
            <LinkContainer to={{ pathname: "/v2/admin/analytics/summary/overview"}}>
              <NavItem eventKey="1">Overview</NavItem>
            </LinkContainer>
            <LinkContainer to={{ pathname: "/v2/admin/analytics/summary/detailed"}}>
...
export default connect(mapStateToProps, mapDispatchToProps)(SummaryAdmin)